...
const AddContactLink = ({offenderId, rankIndex, surname, firstName, addContact, highlight, tabIndex}) => (
    <span>
        <a tabIndex={tabIndex} href='javascript:' className="clickable" title={surname ? `Add contact to ${surname}, ${firstName}` : 'Add contact'} onClick={() => addContact(offenderId, rankIndex, highlight)}>Add contact</a>
    </span>
)
