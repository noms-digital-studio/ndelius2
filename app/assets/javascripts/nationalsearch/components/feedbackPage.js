                        ...
                        <fieldset>
                            ...
                            <div className="form-group">
                                ...
                                <div className="multiple-choice">
                                    <input name="rating" onChange={event => this.handleRatingChange(event)} type="radio"
                            ...
                            <div className="form-group">
                                <label htmlFor="feedback">
                                    <span className="form-label-bold">If you could change anything what would it be?</span>
                                </label>
                                <textarea value={this.state.feedback} className="form-control form-control-3-4" role="textbox"  id="feedback" name="feedback" rows="5" onChange={event => this.handleFeedbackChange(event)}/>
                            </div>
                            <div className="form-group">
