    ...
    <div id='root'>
      <main id='content'>
        ...
        <div className='key-content'>
          ...
          <p className='text-secondary font-xxsmall margin-top medium'>
            <Link to='nationalSearch' className='back-link'>Back to New Search</Link>
          </p>
          ...
          <ul>
            <li className='list-bullet'>
              <h2 className='heading-medium no-margin-bottom no-margin-top'>Refine the results by selecting ‘Yes’ to
                ‘Match all terms’</h2>
          ...
          <ul>
            <li className='list-bullet'>
              <h2 className='heading-medium no-margin-bottom no-margin-top'>Expand the results by selecting ‘No’ to
                ‘Match all terms’</h2>
          ...
          <ul>
            <li className='list-bullet'>
              ...
              <span className='pull-left no-pull-mobile'><SearchHintBox hint='John Smith S1 1AB' /></span>

              <p className='font-medium bold search-hint-middle pull-left no-pull-mobile'>Or</p>

              <span className='pull-left no-pull-mobile'><SearchHintBox hint='John Smith Sheffield' /></span>
          ...
          <Link to='nationalSearch' className='no-underline'><span className='icon prev-arrow' />
            <span className='font-medium'>Previous</span><br />
            <span className='font-xxsmall underline'>New Search</span>
          </Link>
