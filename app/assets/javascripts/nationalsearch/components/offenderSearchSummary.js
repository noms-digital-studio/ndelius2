                ...
                <p className='no-margin bottom'>
                    ...
                    {matchesHighlightedField(offenderSummary.highlight, 'otherIds.pncNumber') &&
                        <span>
                            ...
                            <span id='pncNumber' aria-labelledby="pncNumber-label" className='bold margin-right'><MT text={offenderSummary.otherIds.pncNumber} highlight={offenderSummary.highlight} highlightFieldName='otherIds.pncNumber' /></span>
                        </span>
                    }
                    {matchesHighlightedField(offenderSummary.highlight, 'otherIds.nomsNumber') &&
                        <span>
                            <span id='nomsNumber-label' className='bold'>NOMS:&nbsp;</span>
                            <span id='nomsNumber' aria-labelledby='nomsNumber-label' className='bold margin-right'><MT text={offenderSummary.otherIds.nomsNumber} highlight={offenderSummary.highlight} highlightFieldName='otherIds.nomsNumber'/></span>
                        </span>
                    }
                    {matchesHighlightedField(offenderSummary.highlight, 'otherIds.niNumber') &&
                        <span>
                            <span id='niNumber-label' className='bold'>NI Number:&nbsp;</span>
                            <span id='niNumber' aria-labelledby="niNumber-label" className='bold margin-right'><MT text={offenderSummary.otherIds.niNumber} highlight={offenderSummary.highlight} highlightFieldName='otherIds.niNumber'/></span>
                        </span>
                    }
                    {matchesHighlightedField(offenderSummary.highlight, 'otherIds.croNumber') &&
                        <span>
                            <span id='croNumber-label' className='bold'>CRO:&nbsp;</span>
                            <span id='croNumber' aria-labelledby="croNumber-label" className='bold margin-right'><MT text={offenderSummary.otherIds.croNumber} highlight={offenderSummary.highlight} highlightFieldName='otherIds.croNumber'/></span>
                        </span>
                    }
