                    ...
                    <fieldset className="govuk-fieldset">
                        ...
                        <div className="govuk-radios govuk-!-margin-top-2 govuk-radios--inline">
                            <div className="govuk-radios__item">
                                <input className="govuk-radios__input" type="radio" id="offender-summary-true"
                                       value="true" checked={offenderSummary === 'true'} onChange={() => this.offenderSummary('true')}/>
                                <label className="govuk-label govuk-radios__label"
                                       htmlFor="offender-summary-true"> Yes </label>
                            </div>
                            <div className="govuk-radios__item">
                                <input className="govuk-radios__input" type="radio" id="offender-summary-false"
                                       value="false" checked={offenderSummary === 'false'} onChange={() => this.offenderSummary('false')}/>
                                <label className="govuk-label govuk-radios__label"
                                       htmlFor="offender-summary-false"> No </label>
                            </div>
                        </div>
                    </fieldset>
                </div>
