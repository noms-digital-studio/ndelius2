    ...
    describe('extractMyProbationAreas', () => {
        ...
        context('aggregation with filters that exist in myProbationAreas', () => {
            ...
            it('myProbationAreas has single item with count', () => {
                expect(extractMyProbationAreas(probationAreasFilter, myProbationAreas)).to.eql([{code: 'N01', description: 'Area for N01', count: 8 }])
            })
        })
        ...
        context('aggregation with filters that do not exist in myProbationAreas', () => {
            ...
            it('myProbationAreas has my probation areas with zero counts', () => {
                expect(extractMyProbationAreas(probationAreasFilter, myProbationAreas)).to.eql([{code: 'N03', description: 'Area for N03', count: 0 }, {code: 'N04', description: 'Area for N04', count: 0}])
            })
        })
    })
