import MarkableText, { matchesAnyHighlightedField, matchesHighlightedField } from './markableText'
...
describe('MarkableText component', () => {
    ...
    context('no matches found', () => {
      it('no highlighted element rendered', () => {
        const markedText = shallow(<MarkableText text={'Bobby Beans'} searchTerm={'donkey'}
                                                 highlight={{ someField: ['text'] }} highlightFieldName='someField' />)
  ...
  context('when highlight field does not match', () => {
    context('no matches found', () => {
      it('no highlighted element rendered', () => {
        const markedText = shallow(<MarkableText text={'Bobby Beans'} searchTerm={'donkey'}
                                                 highlight={{ someField: ['text'] }}
                                                 highlightFieldName='someOtherField' />)
  ...
  describe('date handling', () => {
    context('date matches in same format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-13'} searchTerm={'1975-07-13 beans'} isDate
                                                 highlight={{ someField: ['text'] }} highlightFieldName='someField' />)
    ...
    context('date matches in yyyy/MMMM/dd format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-13'} searchTerm={'1975/July/13 beans'}
                                                 isDate highlight={{ someField: ['text'] }}
                                                 highlightFieldName='someField' />)
        expect(markedText.find({ text: '1975-07-13', highlight: true })).to.have.length(1)
      })
    })
    context('date matches in yyyy/MMMM/d format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-03'} searchTerm={'1975/July/3 beans'}
                                                 isDate highlight={{ someField: ['text'] }}
                                                 highlightFieldName='someField' />)
    ...
    context('date matches in yyyy/MMM/dd format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-13'} searchTerm={'1975/Jul/13 beans'}
                                                 isDate highlight={{ someField: ['text'] }}
                                                 highlightFieldName='someField' />)
        expect(markedText.find({ text: '1975-07-13', highlight: true })).to.have.length(1)
      })
    ...
    context('date matches in yyyy/MMM/d format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-03'} searchTerm={'1975/Jul/3 beans'} isDate
                                                 highlight={{ someField: ['text'] }} highlightFieldName='someField' />)
        expect(markedText.find({ text: '1975-07-03', highlight: true })).to.have.length(1)
      })
    })
    ...
    context('date matches in yyyy/MM/d format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-03'} searchTerm={'1975/07/3 beans'} isDate
                                                 highlight={{ someField: ['text'] }} highlightFieldName='someField' />)
        expect(markedText.find({ text: '1975-07-03', highlight: true })).to.have.length(1)
      })
    })
    context('date matches in yyyy/M/dd format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-13'} searchTerm={'1975/7/13 beans'} isDate
                                                 highlight={{ someField: ['text'] }} highlightFieldName='someField' />)
        expect(markedText.find({ text: '1975-07-13', highlight: true })).to.have.length(1)
      })
    })
    context('date matches in yyyy/M/d format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-03'} searchTerm={'1975/7/3 beans'} isDate
                                                 highlight={{ someField: ['text'] }} highlightFieldName='someField' />)
        expect(markedText.find({ text: '1975-07-03', highlight: true })).to.have.length(1)
      })
    })
    context('date matches in dd/MMMM/yyyy format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-13'} searchTerm={'13/July/1975 beans'}
                                                 isDate highlight={{ someField: ['text'] }}
                                                 highlightFieldName='someField' />)
        expect(markedText.find({ text: '1975-07-13', highlight: true })).to.have.length(1)
      })
    ...
    context('date matches in d/MMMM/yyyy format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-03'} searchTerm={'3/July/1975 beans'}
                                                 isDate highlight={{ someField: ['text'] }}
                                                 highlightFieldName='someField' />)
        expect(markedText.find({ text: '1975-07-03', highlight: true })).to.have.length(1)
      })
    ...
    context('date matches in dd/MMM/yyyy format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-13'} searchTerm={'13/Jul/1975 beans'}
                                                 isDate highlight={{ someField: ['text'] }}
                                                 highlightFieldName='someField' />)
        expect(markedText.find({ text: '1975-07-13', highlight: true })).to.have.length(1)
      })
    ...
    context('date matches in d/MMM/yyyy format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-03'} searchTerm={'3/Jul/1975 beans'} isDate
                                                 highlight={{ someField: ['text'] }} highlightFieldName='someField' />)
        expect(markedText.find({ text: '1975-07-03', highlight: true })).to.have.length(1)
      })
    })
    context('date matches in dd/MM/yyyy format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-13'} searchTerm={'13/07/1975 beans'} isDate
                                                 highlight={{ someField: ['text'] }} highlightFieldName='someField' />)
        expect(markedText.find({ text: '1975-07-13', highlight: true })).to.have.length(1)
      })
    })
    context('date matches in d/MM/yyyy format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-03'} searchTerm={'3/07/1975 beans'} isDate
                                                 highlight={{ someField: ['text'] }} highlightFieldName='someField' />)
        expect(markedText.find({ text: '1975-07-03', highlight: true })).to.have.length(1)
      })
    })
    context('date matches in dd/MM/yy format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-13'} searchTerm={'13/07/75 beans'} isDate
                                                 highlight={{ someField: ['text'] }} highlightFieldName='someField' />)
        expect(markedText.find({ text: '1975-07-13', highlight: true })).to.have.length(1)
      })
    })
    ...
    context('date matches in dd-M-yyyy format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-13'} searchTerm={'13-7-1975 beans'} isDate
                                                 highlight={{ someField: ['text'] }} highlightFieldName='someField' />)
        expect(markedText.find({ text: '1975-07-13', highlight: true })).to.have.length(1)
      })
    })
    context('date matches in d-M-yyyy format', () => {
      it('date is highlighted', () => {
        const markedText = shallow(<MarkableText text={'1975-07-03'} searchTerm={'3-7-1975 beans'} isDate
                                                 highlight={{ someField: ['text'] }} highlightFieldName='someField' />)
        expect(markedText.find({ text: '1975-07-03', highlight: true })).to.have.length(1)
      })
    })
