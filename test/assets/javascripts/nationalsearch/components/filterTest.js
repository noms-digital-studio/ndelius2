...
describe('Filter component', () => {
      ...
      beforeEach(() => {
        filter = shallow(<Filter
          ...
          filterValues={[{ code: 'N01', description: 'Some Area', count: 67 }, {
            ...
            description: 'Some Other Area',
            count: 4
          }, { code: 'N03', description: 'Some Other Area', count: 4 }]}
  ...
  describe('selection filter areas', () => {
    ...
    beforeEach(() => {
      filter = shallow(<Filter
        searchTerm='Mr Bean'
        filterValues={[{ code: 'N01', description: 'N01 Area', count: 67 }, {
          code: 'N02',
          description: 'N02 Area',
          count: 4
        }, { code: 'N03', description: 'N03 Area', count: 4 }]}
        currentFilter={['N01', 'N03']}
        addToFilter={addToFilter}
        removeFromFilter={removeFromFilter}
        search={search}
