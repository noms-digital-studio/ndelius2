...
describe('PageSelection component', () => {
    ...
    describe(('rendering of links'), () => {
        ...
        context('no results have been found', () => {
            it('no text rendered', () => {
                const pages = shallow(<PageSelection pageSize={10} pageNumber={0} total={0} gotoPage={gotoPage} searchTerm={'Mr Bean'} probationAreasFilter={[]} searchType='broad'/>)
                expect(pages.text()).to.equal('')
            })
        })
        context('all results fit on one page', () => {
            it('no text rendered', () => {
                const pages = shallow(<PageSelection pageSize={10} pageNumber={1} total={10} gotoPage={gotoPage} searchTerm={'Mr Bean'} probationAreasFilter={[]} searchType='broad'/>)
                expect(pages.text()).to.equal('')
            })
        })
        context('Results don\'t fit on one page', () => {
            it('at least page numbers 1 and 2 rendered', () => {
                const pages = shallow(<PageSelection pageSize={10} pageNumber={1} total={11} gotoPage={gotoPage} searchTerm={'Mr Bean'} probationAreasFilter={[]} searchType='broad'/>)
        ...
        context('Results span exactly 3 pages', () => {
            it('at least page numbers 1, 2 and 3 rendered', () => {
                const pages = shallow(<PageSelection pageSize={3} pageNumber={1} total={9} gotoPage={gotoPage} searchTerm={'Mr Bean'} probationAreasFilter={[]} searchType='broad'/>)
                expect(allPageNumbers(pages)).to.contains('1').and.contains('2').and.contains('3').and.not.contains('4')
            })
            context('when on first', () => {
                let pages;
                beforeEach(() => {
                    pages = shallow(<PageSelection pageSize={3} pageNumber={1} total={9} gotoPage={gotoPage} searchTerm={'Mr Bean'} probationAreasFilter={[]} searchType='broad'/>)
                })
            ...
            context('when on middle page', () => {
                let pages;
                beforeEach(() => {
                    pages = shallow(<PageSelection pageSize={3} pageNumber={2} total={9} gotoPage={gotoPage} searchTerm={'Mr Bean'} probationAreasFilter={[]} searchType='broad'/>)
                })
            ...
            context('when on last page', () => {
                let pages;
                beforeEach(() => {
                    pages = shallow(<PageSelection pageSize={3} pageNumber={3} total={9} gotoPage={gotoPage} searchTerm={'Mr Bean'} probationAreasFilter={[]} searchType='broad'/>)
                })
        ...
        context('Results span just over 3 pages', () => {
            it('at least page numbers 1, 2, 3 and 4 rendered', () => {
                const pages = shallow(<PageSelection pageSize={3} pageNumber={1} total={10} gotoPage={gotoPage} searchTerm={'Mr Bean'} probationAreasFilter={[]} searchType='broad'/>)
        ...
        context('Results span over 10 pages', () => {
            it('only pages up to 10 are displayed', () => {
                const pages = shallow(<PageSelection pageSize={10} pageNumber={1} total={200} gotoPage={gotoPage} searchTerm={'Mr Bean'} probationAreasFilter={[]} searchType='broad'/>)
    ...
    describe('clicking links', () => {
        it('clicking a page link will call gotoPage with page number', () => {
            const pages = shallow(<PageSelection pageSize={3} pageNumber={1} total={9} gotoPage={gotoPage} searchTerm={'Mr Bean'} probationAreasFilter={['N01']} searchType='broad'/>)
        ...
        it('clicking next page link will call gotoPage with current page number + 1', () => {
            let pages = shallow(<PageSelection pageSize={3} pageNumber={1} total={9} gotoPage={gotoPage} searchTerm={'Mr Bean'} probationAreasFilter={['N01']} searchType='broad'/>)
            clickNextLink(pages)
            expect(gotoPage.getCall(0).args[0]).to.equal('Mr Bean');
            expect(gotoPage.getCall(0).args[1]).to.equal('broad');
            expect(gotoPage.getCall(0).args[2]).to.eql(['N01']);
            ...
            pages = shallow(<PageSelection pageSize={3} pageNumber={2} total={9} gotoPage={gotoPage} searchTerm={'Mr Bean'} probationAreasFilter={['N01']} searchType='broad'/>)
            clickNextLink(pages)
            expect(gotoPage.getCall(1).args[0]).to.equal('Mr Bean');
            expect(gotoPage.getCall(1).args[1]).to.equal('broad');
            expect(gotoPage.getCall(1).args[2]).to.eql(['N01']);
        ...
        it('clicking previous page link will call gotoPage with current page number 1 1', () => {
            let pages = shallow(<PageSelection pageSize={3} pageNumber={3} total={9} gotoPage={gotoPage} searchTerm={'Mr Bean'} probationAreasFilter={['N01']} searchType='broad'/>)
