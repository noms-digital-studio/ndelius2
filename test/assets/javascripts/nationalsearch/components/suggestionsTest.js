...
describe('Suggestions component', () => {
    ...
    describe(('rendering of suggestions'), () => {
        ...
        context('no suggestions have been found', () => {
            it('no text rendered', () => {
                const suggestions = shallow(<Suggestions suggestions={[]} search={search} searchTerm={'Gery Smyth'} searchType='broad' probationAreasFilter={[]}/>)
        ...
        context('some suggestions are found', () => {
            ...
            beforeEach(() => {
                ...
                suggestions = shallow(<Suggestions suggestions={suggestionsData} search={search} searchTerm={'Gery Smyth'} searchType='broad' probationAreasFilter={[]}/>)
    ...
    describe('clicking links', () => {
        it('clicking a suggestion calls search with replaced word', () => {
            ...
            const suggestions = shallow(<Suggestions suggestions={suggestionsData} search={search} searchTerm={'Gery Smyth'} searchType='broad' probationAreasFilter={['N01']}/>)
            ...
            expect(search.getCall(1).args[1]).to.equal('broad');
            expect(search.getCall(1).args[2]).to.eql(['N01']);
        })
    })
