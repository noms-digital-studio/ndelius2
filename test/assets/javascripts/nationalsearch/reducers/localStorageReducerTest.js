...
describe("localStorageReducer", () => {
    ...
    describe("when CLEAR_RESULTS action received", () => {
        ...
        beforeEach(() => {
            state = localStorageReducer({searchTerm: 'Mr Bean', probationAreasFilter: {"N01": "N01 Area"}, pageNumber: 3}, {type: CLEAR_RESULTS})
        })
    ...
    describe("when SAVED_SEARCH action received", () => {
        beforeEach(() => {
            state = localStorageReducer({searchTerm: '', probationAreasFilter: {}, pageNumber: 1}, {type: SAVED_SEARCH, searchTerm: 'Mr Bean', probationAreasFilter: {'N01': 'N01 Area'}})
        })
    ...
    describe("when ADD_AREA_FILTER action received", () => {
        context('when no filter set yet', () => {
            beforeEach(() => {
                state = localStorageReducer({searchTerm: '', pageNumber: 1, probationAreasFilter: {}}, {type: ADD_AREA_FILTER, probationAreaCode: 'N01', probationAreaDescription: 'N01 Area'})
            })
        ...
        context('when area code already in filter', () => {
            beforeEach(() => {
                state = localStorageReducer({searchTerm: '', pageNumber: 1, probationAreasFilter: {'N01': 'N01 Area'}}, {type: ADD_AREA_FILTER, probationAreaCode: 'N01', probationAreaDescription: 'N01 Area'})
            })
        ...
        context('when filter set with other codes', () => {
            beforeEach(() => {
                state = localStorageReducer({searchTerm: '', pageNumber: 1,  probationAreasFilter: {'N01': 'N01 Area'}}, {type: ADD_AREA_FILTER, probationAreaCode: 'N02', probationAreaDescription: 'N02 Area'})
            })
    ...
    describe("when REMOVE_AREA_FILTER action received", () => {
        context('when code to remove not in filter', () => {
            beforeEach(() => {
                state = localStorageReducer({searchTerm: '', pageNumber: 1, probationAreasFilter: {'N02': 'N02 Area'}}, {type: REMOVE_AREA_FILTER, probationAreaCode: 'N01'})
            })
        ...
        context('when area code is only one in filter', () => {
            beforeEach(() => {
                state = localStorageReducer({searchTerm: '', pageNumber: 1, probationAreasFilter: {'N01': 'N01 Area'}}, {type: REMOVE_AREA_FILTER, probationAreaCode: 'N01'})
            })
        ...
        context('when area code is amongst others  in filter', () => {
            beforeEach(() => {
                state = localStorageReducer({searchTerm: '', pageNumber: 1, probationAreasFilter: {'N01': 'N01 Area', 'N02': 'N02 Area'}}, {type: REMOVE_AREA_FILTER, probationAreaCode: 'N01'})
            })
