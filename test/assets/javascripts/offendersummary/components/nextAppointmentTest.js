...
describe('NextAppointment component', () => {
  ...
  context('on mount', () => {
    it('next appointment is requested', () => {
      ...
      shallow(<NextAppointment error={false} fetching getNextAppointment={getNextAppointment} />)
  ...
  describe('rendering NextAppointment', () => {
    ...
    context('when fetching', () => {
      beforeEach(() => {
        wrapper = shallow(<NextAppointment fetching error={false} getNextAppointment={stub()} />)
      })
    ...
    context('when in error', () => {
      beforeEach(() => {
        wrapper = shallow(<NextAppointment fetching={false} error getNextAppointment={stub()} />)
      })
  ...
  describe('AppointmentDetails component', () => {
    ...
    context('no next appointment', () => {
      beforeEach(() => {
        wrapper = shallow(<AppointmentDetail noNextAppointment />)
      })
