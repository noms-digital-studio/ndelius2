...
describe('PersonalCircumstances component', () => {
    ...
    context('on mount', () => {
        ...
        beforeEach(() => {
            ...
            shallow(<PersonalCircumstances error={false} fetching={true} getOffenderPersonalCircumstances={getOffenderPersonalCircumstances}/>)
        })
    ...
    describe('rendering PersonalCircumstances', () => {
        ...
        context('when fetching', () => {
            beforeEach(() => {
                wrapper = shallow(<PersonalCircumstances fetching={true} error={false} getOffenderPersonalCircumstances={stub()}/>)
            })
        ...
        context('when finished fetching', () => {
            beforeEach(() => {
                wrapper = shallow(<PersonalCircumstances  fetching={false} error={false} circumstances={[aPersonalCircumstance()]} getOffenderPersonalCircumstances={stub()}/>)
            })
        ...
        context('when in error', () => {
            beforeEach(() => {
                wrapper = shallow(<PersonalCircumstances  fetching={false} error={true} circumstances={[]} getOffenderPersonalCircumstances={stub()}/>)
            })
