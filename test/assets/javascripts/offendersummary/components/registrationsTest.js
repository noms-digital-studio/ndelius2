...
describe('Registrations component', () => {
    ...
    describe('registration rendering', () => {
        context('no registrations', () => {
            beforeEach(() => {
                wrapper = shallow(<Registrations registrations={[]} error={false} fetching={false} getOffenderRegistrations={stub()}/>)
            })
        ...
        context('some registrations', () => {
            beforeEach(() => {
                wrapper = shallow(<Registrations registrations={someRegistrations()} error={false} fetching={false} getOffenderRegistrations={stub()}/>)
            })
        ...
        context('a high rosh registration', () => {
            beforeEach(() => {
                wrapper = shallow(<Registrations registrations={[aRegistration({type: {description: 'Very High RoSH'}, register: {description: 'RoSH'}, startDate: '2018-12-11', riskColour: 'Red'})]} error={false} fetching={false} getOffenderRegistrations={stub()}/>)
            })
        ...
        context('a low rosh registration', () => {
            beforeEach(() => {
                wrapper = shallow(<Registrations registrations={[aRegistration({type: {description: 'Low RoSH'}, register: {description: 'RoSH'}, startDate: '2018-12-11', riskColour: 'Green'})]} error={false} fetching={false} getOffenderRegistrations={stub()}/>)
            })
