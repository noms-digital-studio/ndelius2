...
describe('Notes component', () => {
    describe('rendering', () => {
        ...
        context('when fetching', () => {
            beforeEach(() => {
                wrapper = shallow(<Notes notes='' fetching={true} error={false} />)
            })
        ...
        context('when in error', () => {
            beforeEach(() => {
                wrapper = shallow(<Notes notes='' fetching={false} error={true} />)
            })
        ...
        context('many notes', () => {
            beforeEach(() => {
                wrapper = shallow(<Notes notes={'This is the first note\n----------------------------\nThis is the second note\n----------------------------\nThis is the third note'} fetching={false} error={false} />)
            })
