...
describe('OffenderSummaryPage component', () => {
  ...
  context('on mount', () => {
    it('offender details are requested', () => {
      ...
      shallow(<OffenderSummaryPage getOffenderDetails={getOffenderDetails} fetching />)
  ...
  describe('rendering', () => {
    ...
    context('when fetching', () => {
      beforeEach(() => {
        page = shallow(<OffenderSummaryPage getOffenderDetails={stub()} fetching error={false} />)
      })
    ...
    context('when in error', () => {
      beforeEach(() => {
        page = shallow(<OffenderSummaryPage getOffenderDetails={stub()} fetching={false} error />)
      })
