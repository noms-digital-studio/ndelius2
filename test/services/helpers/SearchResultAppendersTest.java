...
public class SearchResultAppendersTest {
    ...
    public void addsHighlightNode() {
        ...
        ObjectNode sna = SearchResultAppenders.appendHighlightFields(rootNode, "dont care", highlightFieldMap);
    ...
    public void addsHighlightNodeWithDateOfBirth() {
        ...
        ObjectNode sna = SearchResultAppenders.appendHighlightFields(rootNode, "2018-03-20", highlightFieldMap);
        assertThat(sna.get("highlight")).isNotNull();
